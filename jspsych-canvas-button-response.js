 ...
 *
 * a jspsych plugin for button response to questions presented using canvas
 * drawing tools. Supports multiple buttons.
...
jsPsych.plugins['canvas-button-response'] = (function() {
    ...
    plugin.info = {
        ...
        description: 'Collect button response(s) to stimuli '+
